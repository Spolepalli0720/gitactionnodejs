...
/**
 * Get the 'custom:collection' attribute value of the loop characteristics.
 *
 * @param {djs.model.Base} element
 *
 * @return {string} the 'custom:collection' value
 */
function getCollection(element) {
    return getProperty(element, 'custom:collection');
}

/**
 * Get the 'custom:elementVariable' attribute value of the loop characteristics.
 *
 * @param {djs.model.Base} element
 *
 * @return {string} the 'custom:elementVariable' value
 */
function getElementVariable(element) {
    return getProperty(element, 'custom:elementVariable');
}
...
module.exports = function (element, bpmnFactory, translate) {
    ...
    entries.push(entryFactory.textField({
        ...
        set: function (element, values) {
            ...
            return cmdHelper.updateBusinessObject(element, loopCharacteristics, {
                'custom:collection': values.collection || undefined
            });
        },
    ...
    entries.push(entryFactory.textField({
        ...
        set: function (element, values) {
            var loopCharacteristics = getLoopCharacteristics(element);
            return cmdHelper.updateBusinessObject(element, loopCharacteristics, {
                'custom:elementVariable': values.elementVariable || undefined
            });
        }
    }));
