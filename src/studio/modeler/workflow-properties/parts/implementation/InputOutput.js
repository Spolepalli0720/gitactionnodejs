...
module.exports = function (element, bpmnFactory, options, translate) {
    ...
    var TYPE_LABEL = {
        'custom:Map': translate('Map'),
        'custom:List': translate('List'),
        'custom:Script': translate('Script')
    };
    ...
    var inputEntry = extensionElementsEntry(element, bpmnFactory, {
        ...
        createExtensionElement: newElement('custom:InputParameter', 'inputParameters'),
    ...
    if (ensureOutparameterSupported(element, insideConnector)) {
        var outputEntry = extensionElementsEntry(element, bpmnFactory, {
            ...
            createExtensionElement: newElement('custom:OutputParameter', 'outputParameters'),
