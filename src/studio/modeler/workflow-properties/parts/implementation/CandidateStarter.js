...
module.exports = function (element, bpmnFactory, options, translate) {
    ...
    var candidateStarterGroupsEntry = entryFactory.textField({
        ...
        get: function (element, node) {
            ...
            var candidateStarterGroups = bo.get('custom:candidateStarterGroups');
        ...
        set: function (element, values) {
            ...
            return cmdHelper.updateBusinessObject(element, bo, {
                'custom:candidateStarterGroups': values.candidateStarterGroups || undefined
            });
        }
    ...
    var candidateStarterUsersEntry = entryFactory.textField({
        ...
        get: function (element, node) {
            var bo = getBusinessObject(element);
            var candidateStarterUsers = bo.get('custom:candidateStarterUsers');
        ...
        set: function (element, values) {
            var bo = getBusinessObject(element);
            return cmdHelper.updateBusinessObject(element, bo, {
                'custom:candidateStarterUsers': values.candidateStarterUsers || undefined
            });
        }
