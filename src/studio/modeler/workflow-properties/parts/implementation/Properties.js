...
/**
 * Get all dpie:property objects for a specific business object
 *
 * @param  {ModdleElement} parent
 *
 * @return {Array<ModdleElement>} a list of dpie:property objects
 */
...
/**
 * Get all dpie:Properties object for a specific business object
 *
 * @param  {ModdleElement} parent
 *
 * @return {ModdleElement} a dpie:Properties object
 */
...
/**
 * Get first dpie:Properties object for a specific bpmn:ExtensionElements
 * business object.
 *
...
/**
 * Create a dpie:property entry using tableEntryFactory
 *
...
module.exports = function (element, bpmnFactory, options, translate) {
    ...
    assign(options, {
        ...
        addElement: function (element, node) {
            ...
            if (!properties) {
                properties = elementHelper.createElement('custom:Properties', {}, parent, bpmnFactory);
            ...
            var property = elementHelper.createElement('custom:Property', propertyProps, properties, bpmnFactory);
