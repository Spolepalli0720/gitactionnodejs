...
module.exports = function (element, bpmnFactory, options, translate) {
    ...
    var asyncBeforeEntry = entryFactory.checkbox({
        ...
        set: function (element, values) {
            ...
            var props = {
                'custom:asyncBefore': asyncBefore,
                'custom:async': false
            };

            var commands = [];
            if (!isAsyncAfter(bo) && !asyncBefore) {
                props = assign({ 'custom:exclusive': true }, props);
    ...
    var exclusiveEntry = entryFactory.checkbox({
        ...
        set: function (element, values) {
            var bo = getBusinessObject(element);
            return cmdHelper.updateBusinessObject(element, bo, { 'custom:exclusive': !!values.exclusive });
        },
