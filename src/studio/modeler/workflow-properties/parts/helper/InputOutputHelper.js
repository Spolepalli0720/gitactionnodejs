...
InputOutputHelper.getInputOutput = function (element, insideConnector) {
    if (!insideConnector) {
        ...
        return (getElements(bo, 'custom:InputOutput') || [])[0];
    }
...
InputOutputHelper.getConnector = function (element) {
    var bo = implementationTypeHelper.getServiceTaskLikeBusinessObject(element) || implementationTypeHelper.getDataStoreLikeBusinessObject(element);
    return bo && (getElements(bo, 'custom:Connector') || [])[0];
};
