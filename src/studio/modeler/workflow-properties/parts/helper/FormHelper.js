...
FormHelper.getFormData = function (element) {
    ...
    var formData = getExtensionElements(bo, 'custom:FormData');
...
/**
 * Get all dpie:value objects for a specific form field from the business object
 *
 * @param  {ModdleElement} formField
 *
 * @return {Array<ModdleElement>} a list of dpie:value objects
 */
