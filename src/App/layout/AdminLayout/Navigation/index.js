...
class Navigation extends Component {
    ...
    render() {
        // STUDIO_CUSTOMIZATION
        const navigation = this.props.history.location.pathname.startsWith('/solutions/') ?
            menuSolutions
            :
            this.props.history.location.pathname.startsWith('/environments/') ?
                menuEnvironments
                :
                menuStudio;
